          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Application CL-2024-1247 – Rajesh Kumar</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="card-shadow">
            ...
            <CardContent className="space-y-2">
              <div className="flex justify-between text-sm"><span className="text-muted-foreground">Account Holder</span><span className="font-medium">Rajesh Kumar</span></div>
